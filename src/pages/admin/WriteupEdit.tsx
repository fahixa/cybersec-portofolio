...
import { Save, ArrowLeft, Eye, Trash2, Plus } from 'lucide-react';
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-blue-600 dark:text-green-400 transition-colors duration-300">
              {isNew ? 'Create New Writeup' : 'Edit Writeup'}
            </h1>
          </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white/95 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-600/30 rounded-lg p-4 shadow-lg dark:shadow-2xl transition-colors duration-300">
              <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white mb-4 transition-colors duration-300">Publish</h3>
            ...
            {/* Difficulty */}
            <div className="bg-white/95 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-600/30 rounded-lg p-4 shadow-lg dark:shadow-2xl transition-colors duration-300">
              <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white mb-4 transition-colors duration-300">Difficulty</h3>
              <select
