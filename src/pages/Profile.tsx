        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            ...
            <AnimatedCard>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {displayProfile.skills.map((skill, index) => (
                  <div
                    key={index}
                    className="bg-blue-50 dark:bg-black/40 border border-blue-200 dark:border-green-500/30 rounded-lg p-3 text-center transition-colors duration-300"
                  >
                    <span className="text-blue-700 dark:text-green-400 font-mono text-xs sm:text-sm transition-colors duration-300">{skill}</span>
                  </div>
                ))}
              </div>
            </AnimatedCard>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {isValidCertificationUrl(cert) && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center mt-3 text-xs text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300 transition-colors group"
                            >
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              <AnimatedCard className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-blue-600 dark:text-green-400 font-mono mb-1 transition-colors duration-300">50+</div>
                <div className="text-xs text-gray-500 dark:text-gray-400 font-mono transition-colors duration-300">CTF Wins</div>
              </AnimatedCard>
              <AnimatedCard className="text-center" glowColor="cyan">
                <div className="text-xl sm:text-2xl font-bold text-cyan-600 dark:text-cyan-400 font-mono mb-1 transition-colors duration-300">25+</div>
                <div className="text-xs text-gray-500 dark:text-gray-400 font-mono transition-colors duration-300">Bug Bounties</div>
              </AnimatedCard>
              <AnimatedCard className="text-center" glowColor="purple">
                <div className="text-xl sm:text-2xl font-bold text-purple-600 dark:text-purple-400 font-mono mb-1 transition-colors duration-300">100+</div>
                <div className="text-xs text-gray-500 dark:text-gray-400 font-mono transition-colors duration-300">Vulnerabilities</div>
              </AnimatedCard>
            </div>
          </div>
        </div>
