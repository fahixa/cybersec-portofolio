...
export default function Writeups() {
  ...
  const loadWriteups = async () => {
    try {
      ...
      errorHandler.logError('Error loading writeups', error);
      setWriteups([]);
    } finally {
      setLoading(false);
    }
    ...
    return (
      <div className="min-h-screen pt-16 sm:pt-20 bg-gray-50 dark:bg-black transition-colors duration-300">
        <div className="flex items-center justify-center min-h-[50vh]">
          <LoadingSpinner size="lg" text="Loading writeups..." />
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen pt-16 sm:pt-20 bg-gray-50 dark:bg-black transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            <Terminal className="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" />
            <h3 className="text-xl font-mono text-gray-500 dark:text-gray-500 mb-2">
              Unable to load writeups
            </h3>
