...
INSERT INTO profiles (
  ...
  'Passionate cybersecurity professional with 5+ years of experience in penetration testing, vulnerability research, and bug bounty hunting. Specialized in web application security, network security, and reverse engineering. Committed to securing digital infrastructure and helping organizations identify and remediate security vulnerabilities.',
  '5+ years in cybersecurity with focus on web application testing and vulnerability research. Discovered 50+ critical vulnerabilities across various platforms including major e-commerce sites, financial institutions, and government portals. Active participant in bug bounty programs with recognition from top companies.',
  ARRAY[
