...
-- Make sure to run create_tables.sql first!
...
BEGIN
    ...
    RAISE NOTICE 'Profile created/updated with ID: %', profile_uuid;
...
## 12. YARA - Malware Identification
...
# Network connections
index=network src_ip=192.168.1.* | stats count by dest_ip

# Malware indicators
index=* "malware" OR "virus" OR "trojan"
```

## 14. OSSEC - Host-based Intrusion Detection
...
### Overview
The ELK Stack is a collection of three open-source products for log analysis.
...
### For Beginners
1. Start with Nmap for network discovery
2. Learn Burp Suite for web application testing
3. Practice with Metasploit for exploitation
4. Use Wireshark for network analysis

### For Intermediate Users
5. Master SQLMap for database testing
6. Learn Gobuster for content discovery
7. Practice with John the Ripper for password cracking
8. Use Nikto for web server scanning

### For Advanced Users
9. Implement Aircrack-ng for wireless testing
10. Learn Volatility for memory forensics
11. Create YARA rules for malware detection
12. Deploy SIEM solutions like Splunk
...
- **Technical expertise**: Become the go-to expert
- **Innovation**: Drive new security initiatives
- **Cross-functional collaboration**: Work with other departments

### Management Track
- **Team building**: Recruit and develop talent
- **Budget management**: Allocate resources effectively
- **Strategic planning**: Align security with business goals
- **Stakeholder communication**: Present to executives

### Executive Preparation
- **Business acumen**: Understand business operations
- **Financial literacy**: Manage budgets and ROI
- **Communication skills**: Present to board of directors
- **Industry knowledge**: Stay current with trends
...
- **Vulnerability research**: Find new security flaws
- **Tool development**: Create security tools
- **Academic research**: Contribute to security knowledge
- **Speaking engagements**: Share your expertise
...
Incident Response: $75,000 - $125,000
...
3. **Consider total compensation**: Benefits, equity, training
4. **Be prepared to walk**: Have alternatives ready

### Factors Affecting Salary
- **Location**: Major cities typically pay more
- **Industry**: Finance and healthcare pay premiums
- **Company size**: Large enterprises often pay more
- **Clearance level**: Government clearances add value
- **Specialization**: Niche skills command higher salaries

## Chapter 8: Job Search Strategy
...
Experience Section:
- Use action verbs (Implemented, Analyzed, Designed)
- Quantify achievements (Reduced incidents by 40%)
- Include relevant keywords
- Highlight security-specific accomplishments
```
...
2. **Scenario-Based Questions**
   ...
   - Explain how you''d secure a new application
...
- **LinkedIn optimization**: Professional profile and connections
- **Industry events**: Attend conferences and meetups
- **Professional associations**: Join relevant organizations
- **Mentorship**: Find mentors and become one yourself

## Chapter 9: Common Career Challenges

### Imposter Syndrome
- **Recognition**: Acknowledge your achievements
- **Continuous learning**: Stay updated with skills
- **Community support**: Connect with peers
- **Mentorship**: Seek guidance from experienced professionals

### Skill Gaps
- **Assessment**: Identify areas for improvement
- **Learning plan**: Create structured development goals
- **Practical application**: Apply new skills in projects
- **Feedback**: Seek input from colleagues and mentors

### Work-Life Balance
- **Boundaries**: Set clear work hours
- **Stress management**: Develop coping strategies
- **Health**: Maintain physical and mental wellness
- **Interests**: Pursue hobbies outside of security
...
- **AI Security Specialist**: Secure AI/ML systems
- **IoT Security Engineer**: Protect connected devices
- **Quantum Security Researcher**: Develop quantum-safe solutions
- **Zero Trust Architect**: Design zero trust implementations
...
- SANS (premium training)

### Communities
- Reddit: r/cybersecurity, r/netsec
- Discord: Various cybersecurity servers
- Slack: InfoSec community workspaces
- Local meetups and chapters

Start your journey today, and remember: every expert was once a beginner!',
            'career',
            false,
            true,
            25,
...
SELECT 'Data dummy berhasil ditambahkan! Silakan login dengan email: fakhrityhikmawan@gmail.com dan password: tes123' AS status;